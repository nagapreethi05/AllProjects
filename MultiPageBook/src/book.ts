class Bookss {
    ...
    price: number;
    rating: string;  
    constructor(id:string,title:string,author:string,price:number,rating:string) {
    this.id = id;
    this.title=title;
    this.author=author;
    this.price= price;
...
class bookManager {
    ...
    searchById(bookData:Bookss[],searchValue:string) {
...
searchByAuthor(bookData:Bookss[],searchValue:string) {
    ...
    for (let i = 0; bookData.length; i++) {
        if (bookData[i].author.toLowerCase().includes(searchValue)) {
            let id1 = bookData[i].id;
            let title1 = bookData[i].title;
            let author1 = bookData[i].author;
            let price1=bookData[i].price;
...
searchByRating(bookData:Bookss[],searchValue:string) {
